// Generated from /home/andrea/Documents/Universita/FOOLProject/src/compiler/FOOL.g4 by ANTLR 4.13.1
package compiler;
...
public class FOOLParser extends Parser {
	...
	public static final int
		...
		COMMA=10, EQ=11, LESSEQ=12, MOREEQ=13, OR=14, AND=15, DIV=16, NOT=17, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"COLON", "COMMA", "EQ", "LESSEQ", "MOREEQ", "OR", "AND", "DIV", "NOT", 
	...
	@SuppressWarnings("CheckReturnValue")
	public static class MoreeqContext extends ExpContext {
		public List<ExpContext> exp() {
			return getRuleContexts(ExpContext.class);
		}
		public ExpContext exp(int i) {
		...
		public TerminalNode MOREEQ() { return getToken(FOOLParser.MOREEQ, 0); }
		public MoreeqContext(ExpContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLListener ) ((FOOLListener)listener).enterMoreeq(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof FOOLListener ) ((FOOLListener)listener).exitMoreeq(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof FOOLVisitor ) return ((FOOLVisitor<? extends T>)visitor).visitMoreeq(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
	...
	private ExpContext exp(int _p) throws RecognitionException {
		...
		try {
			...
			case 9:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 6463029268L) != 0)) {
					{
					setState(103);
					exp(0);
					setState(108);
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 5:
						{
						_localctx = new MoreeqContext(new ExpContext(_parentctx, _parentState));
						pushNewRecursionContext(_localctx, _startState, RULE_exp);
						setState(128);

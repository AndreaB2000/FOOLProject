...
public interface FOOLListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code moreeq}
	 * labeled alternative in {@link FOOLParser#exp}.
	 * @param ctx the parse tree
	 */
	void enterMoreeq(FOOLParser.MoreeqContext ctx);
	/**
	 * Exit a parse tree produced by the {@code moreeq}
	 * labeled alternative in {@link FOOLParser#exp}.
	 * @param ctx the parse tree
	 */
	void exitMoreeq(FOOLParser.MoreeqContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterLesseq(FOOLParser.LesseqContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lesseq}
	 * labeled alternative in {@link FOOLParser#exp}.
	 * @param ctx the parse tree
	 */
	void exitLesseq(FOOLParser.LesseqContext ctx);
	/**
